                            ...
                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:30%;" class="text-center">Room & Seat</th>
                                        <th style="width:30%;" class="text-center">Token Number</th>                                       
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    @foreach($lunch_tokens as $key => $data)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><span style="font-weight: 500;">{{ $data->lunch }}</span></td>
